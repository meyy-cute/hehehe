...
do
    ...
    task.spawn(function()
        ...
        RaceVal.Text = race .. " V"  .. game.ReplicatedStorage.Remotes.CommF_:InvokeServer("getRaceLevel")
        ...
        if ScriptStorage.Backpack["Cursed Dual Katana"] then SetItemState(1, true) else SetItemState(1, false) end
        if ScriptStorage.Backpack["Mirror Fractal"] >= 1 then SetItemState(2, true) else SetItemState(2, false) end
        if ScriptStorage.Backpack['Valkyrie Helm'] then SetItemState(3, true) else SetItemState(3, false) end
        if ScriptStorage.Backpack["Skull Guitar"] then SetItemState(4, true) else SetItemState(4, false) end

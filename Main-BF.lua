...
local v16 = {
    Home = v15:AddTab({
        Title = "Tab Information", Icon = "book-copy"
    }),
    Main = v15:AddTab({
        Title = "Tab Farming", Icon = "tractor"
    }),
    Sea = v15:AddTab({
        Title = "Tab Event", Icon = "fish"
    }),
    ITM = v15:AddTab({
        Title = "Tab Farming Other", Icon = "sprout"
    }),
    Setting = v15:AddTab({
        Title = "Setting Farm", Icon = "settings"
    }),
    Status = v15:AddTab({
        Title = "Tab Status And Server", Icon = "users"
    }),
    Stats = v15:AddTab({
        Title = "Tab Stats", Icon = "chart-bar"
    }),
    Player = v15:AddTab({
        Title = "Tab Local Player", Icon = "user"
    }),
    Teleport = v15:AddTab({
        Title = "Tab Teleport", Icon = "tree-palm"
    }),
    Visual = v15:AddTab({
        Title = "Tab Visual", Icon = "eye"
    }),
    Fruit = v15:AddTab({
        Title = "Tab Esp And Fruit", Icon = "apple"
    }),
    Raid = v15:AddTab({
        Title = "Tab Raid", Icon = "train-front"
    }),
    Race = v15:AddTab({
        Title = "Tab Upgrade Race", Icon = "rabbit"
    }),
    Shop = v15:AddTab({
        Title = "Tab Shop", Icon = "store"
    }),
    Misc = v15:AddTab({
        Title = "Tab Misc", Icon = "album"
    })
};
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=90904290911669";--thay id áº£nh vÃ o
...
local TweenService = v26

local UIStroke = v23:FindFirstChild("UIStroke") or Instance.new("UIStroke")
UIStroke.Parent = v23
...
local UICorner = v23:FindFirstChild("UICorner") or Instance.new("UICorner")
UICorner.Parent = v23
UICorner.CornerRadius = UDim.new(1,0)

local UIGradient = v23:FindFirstChild("UIGradient") or Instance.new("UIGradient")
UIGradient.Parent = v23
...
v23.MouseButton1Down:Connect(function()
    ...
    TweenService:Create(v23,TweenInfo.new(0.2,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),{
        Rotation = 15
    }):Play()

    task.delay(0.2,function()
        TweenService:Create(v23,TweenInfo.new(0.25,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
            Rotation = 0
        }):Play()
    end)
    ...
    if not toggled then
        ...
        TweenService:Create(v23,TweenInfo.new(0.4,Enum.EasingStyle.Elastic,Enum.EasingDirection.Out),{
        ...
        TweenService:Create(UIGradient,TweenInfo.new(0.4),{
            Rotation = 225
        }):Play()
        ...
        TweenService:Create(v23,TweenInfo.new(0.3,Enum.EasingStyle.Back,Enum.EasingDirection.Out),{
        ...
        TweenService:Create(UIGradient,TweenInfo.new(0.3),{
            Rotation = 45
        }):Play()
    end
...
v16.Home:AddButton({
    Title = "VerSon : 1.29",
    Description = "Update : 29 Bloxfruits",
    Callback = function()
        setclipboard("");
    end
});
v16.Home:AddButton({
    Title = "The game currently supports",
...
v16.Home:AddButton({
    Title = "Key :",
    Description = "Currently active | AstraXHub",
    Callback = function()
        setclipboard("");
    end
});
v16.Home:AddButton({
    Title = "What's new in this script update?",
    Description = "With the new version, we have: updated monster hunting areas, fixed flying bugs, and a new dungeon system for Blox Fruits",
    Callback = function()
        setclipboard("");
    end
});
        ...
        while wait() do
            pcall(function()
                ...
                elseif (string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87) then
                    v491:SetDesc("CÃ²n: " .. string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"), 39, 40) .. "");
...
if Sea3 then
    ...
    function UpdateKitsune()
        if game:GetService("Workspace").Map:FindFirstChild("KitsuneIsland") then
            v499:SetDesc("Kitsune Island : âœ…ï¸");
        else
            v499:SetDesc("Kitsune Island : âŒï¸");
        end
    end
    spawn(function()
        pcall(function()
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Astra X Hub",
                    Content = "Prehistoric islands have been found!",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v605 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Astra X Hub",
                    Content = "The mystic island has been found!",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v616 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "Astra X Hub",
                    Content = "Leviathan Island has been found!",
                    Duration = 10
                });
                v513 = true;
            end
...
local v90 = v16.Setting:AddToggle("ToggleBringMob", {
    Title = "Bring Mob",
    Description = "It should be turned on for a better experience",
    Default = true
});
...
local v92 = v16.Setting:AddToggle("ToggleWhite", {
    Title = "White Screen",
    Description = "Tool to fix lag and game freezes",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "Give Up Normal Fruitâ€”>Raid Chip",
    Description = "",
    Default = false
});
...
local v56 = v16.Shop:AddSection("VÃµ");
v16.Shop:AddButton({
    Title = "Black Leg",
    Description = "",
    Callback = function()
    ...
    pcall(function()
        while wait() do
            if ggame:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                v169:SetDesc("Prehistoric Island: âœ…ï¸");
            else
                v169:SetDesc("Prehistoric Island: âŒï¸");
            end
        end
    end);
end);

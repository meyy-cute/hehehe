...
local textSize = 14
-------------------------------------------------------------------------------
-- BẢNG MÀU DARK THEME CHUẨN MẸO CHỈNH SỬA BỞI MEYY
-------------------------------------------------------------------------------
local backgroundColor = Color3.fromRGB(24, 24, 24)      -- Nền khung code tối sâu chuẩn Dark
local operatorColor    = Color3.fromRGB(198, 120, 221)  -- Từ khóa/Toán tử (Tím pastel nhẹ)
local functionColor    = Color3.fromRGB(97, 175, 239)   -- Tên hàm/Function (Xanh dương)
local stringColor      = Color3.fromRGB(152, 195, 121)  -- Chuỗi/String (Xanh lá mềm)
local numberColor      = Color3.fromRGB(209, 154, 102)  -- Số/Number (Cam đất)
local booleanColor     = numberColor                    -- True/False/Nil
local objectColor      = Color3.fromRGB(229, 192, 123)  -- Object/Instance (Vàng kem)
local defaultColor     = Color3.fromRGB(171, 178, 191)  -- Chữ mặc định (Trắng xám dễ nhìn)
local commentColor     = Color3.fromRGB(92, 99, 112)    -- Chú thích/Comment (Xám trầm)
local lineNumberColor  = Color3.fromRGB(76, 82, 99)     -- Số dòng
local genericColor     = Color3.fromRGB(171, 178, 191)  -- Ký tự chung
-------------------------------------------------------------------------------
